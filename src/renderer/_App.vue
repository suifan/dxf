      ...
      <div class="sidebar" id="sidebar">
        ...
        <div class="router">
          ...
          <router-link @click.native="clicks($event)" @mouseover.native="mouseover($event)" 
            ...
            <div class="mask"></div>
            <span class="fa fa-home fa-lg">主页</span>
            <div class="title"><div class="triangle"></div> 主页</div>
          </router-link>
          
          <router-link @click.native="clicks($event)" @mouseover.native="mouseover($event)" 
            @mouseout.native="mouseout($event)" to="/DistributeUser"  active-class="link-active">
            <div class="mask"></div>
            <span class="iconfont icon-distribute">账号管理</span>
            <div class="title"><div class="triangle"></div> </div>
          </router-link>
          ...
          <router-link @click.native="clicks($event)" @mouseover.native="mouseover($event)" 
            ...
            <div class="mask"></div>
            <span class="iconfont icon-update">数据管理</span>
            <div class="title"><div class="triangle"></div> </div>
          </router-link>
          
          <router-link @click.native="clicks($event)" @mouseover.native="mouseover($event)" 
            @mouseout.native="mouseout($event)" to="/videoList" active-class="link-active">
            <div class="mask"></div>
            <span class="fa fa-upload fa-lg">视频清单</span>
            <div class="title"><div class="triangle"></div> </div>
          </router-link>
        </div>
